...
mlflow_log_param("ntree", 50)
mlflow_log_param("task", "binary classification")
mlflow_set_tag("mlflow.runName", "RandomForest-baseline")
mlflow_log_param(
  "features",
  "AST,ALT,GGT,BIL,ALP,ALB,CHOL,CHE,CREA,Age,Sex"
)

table(test_bin$Target_binary)

cm <- confusionMatrix(predictions, test_bin$Target_binary, positive = "Class1")
